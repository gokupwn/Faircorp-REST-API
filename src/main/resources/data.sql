INSERT INTO BUILDING(id, outside_temperature) VALUES (-11, 30);
INSERT INTO BUILDING(id, outside_temperature) VALUES (-12, 40);

INSERT INTO ROOM(id, name, floor, current_temperature, target_temperature, building_id) VALUES(-10, 'Room1', 1, 22.3, 20.0, -11);
INSERT INTO ROOM(id, name, floor, building_id) VALUES(-9, 'Room2', 1, -11);

INSERT INTO ROOM(id, name, floor, building_id) VALUES(-13, 'Room3', 1, -12);
